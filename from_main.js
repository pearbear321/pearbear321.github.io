function spireHeirloom(spire) {
  ...
  createHeirloom(zone)
  let heirloom =
    game.global.heirloomsExtra[game.global.heirloomsExtra.length - 1]
...
function giveSingleAchieve(acheev) {
  return
}
...
var Fluffy = {
  ...
  damageModifiers2: [
    ...
    171, 241, 321, 411, 511, 621, 741, 741,
  ],
  rewards: [
    "stickler",
    "helium",
  ...
  pat: function () {
    var stat =
      game.global.universe == 1 ? game.stats.fluffyPats : game.stats.scruffyPats
    stat.valueTotal++
  ...
  rewardConfig: {
    ...
    tenacity: {
      description:
        "Start each zone with 15% of last zone's Tenacity time already applied.",
    },
    smithy: {
      description:
    ...
    biggerbetterheirlooms: {
      description:
        "Allows you to spend an additional 10% of your total earned Nullifium on all of your Heirlooms.",
    },
    justdam: {
      description:
